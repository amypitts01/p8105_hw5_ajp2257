...
Make a second plot (or overlay on the first) the average estimate of $\hat{\mu}$  \textbf{only in samples for which the null was rejected} on the y axis and the true value of $\mu$ on the x axis.
```{r}
sim_results %>% 
   mutate(
    mu = str_c("mu = ", mu),
